...
@app.route('/logo')
def logo():
    return "There is a picture of whale on Docker's logo. Did you know that?"

@app.route('/zoo/<animal>/<name>')
def create(animal=None, name=None):
  return 'A ' + animal + ' named ' + name + ' lives in the zoo '